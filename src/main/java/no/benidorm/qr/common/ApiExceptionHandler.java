...
public class ApiExceptionHandler {
    ...
    ResponseEntity<ProblemDetail> handleDisabled(DisabledException ex, HttpServletRequest request) {
        return problem(HttpStatus.FORBIDDEN, "Email is not verified", request);
    }
